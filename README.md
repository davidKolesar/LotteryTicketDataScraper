This program scrapes metadata publicly provided from the Pennsylvania Lottery website and (in real time) updates published data on scratch-off tickets regarding :
